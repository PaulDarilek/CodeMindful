...
namespace ContentManagement.Models
{
    ...
    public class Drive : IDateCreated, IDateUpdated, INotes, ITags, IProperties
    {
        ...
        public Drive() 
        {
            ...
            MachineNames ??= new HashSet<string>(StringComparer.OrdinalIgnoreCase);
        ...
        public Drive(DriveInfo drive) : this()
        {
            DriveLetter = drive.GetDriveLetter() ?? string.Empty;
        ...
        public void UnionWith(Drive other)
        {
            ...
            other.MachineNames ??= new HashSet<string>(StringComparer.OrdinalIgnoreCase);
            other.Tags ??= new HashSet<string>(StringComparer.OrdinalIgnoreCase);
            other.Properties ??= new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase);
    ...
    public static class DriveExtensions
    {
        ...
        public static string? GetVolSerialNumber(this DriveInfo info)
        {
            ...
            string? driveLetter =
                ...
                info.Name?.Length > 2 ? info.Name[..2] :
                null;
            ...
            var serial = lines.FirstOrDefault(x => x.StartsWith(search))?[search.Length..];
