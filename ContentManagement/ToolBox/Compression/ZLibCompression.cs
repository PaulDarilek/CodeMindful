...
/// <summary>Class to Handle ZLib compatible compression (compatible with SQLite3 Archive file)</summary>
/// <remarks>
...
public static class ZLibCompression
{
    ...
    /// <returns></returns>
    private static byte[] Adler32_Trailer(byte[] buffer, int offset, long count)
    {
