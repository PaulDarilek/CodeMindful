...
namespace ContentManagement
{
    public static class ExtensionMethods
    {
        ...
        public static HashSet<string> ToHashSet(this string delimitedString, string delimitors = "\r\n")
            => new(delimitedString.SplitToLines(delimitors, removeEmptyLines: true), StringComparer.OrdinalIgnoreCase);
        ...
        public static string FirstNotNullOrWhiteSpace(this string? original, string? otherValue) 
            => !string.IsNullOrWhiteSpace(original) ? original : !string.IsNullOrWhiteSpace(otherValue) ? otherValue : string.Empty;
